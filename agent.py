...
class WebAgent(BaseAgent):
    ...
    async def act(self, environment_response: str) -> str:
        await self.websocket.send_text(environment_response)
        res = await self.websocket.receive_text()
        return f"""```\n{res}\n```"""
    ...
    async def win(self):
        await self.websocket.send_text("you win 🎈")
